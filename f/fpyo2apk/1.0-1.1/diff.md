# Comparing `tmp/fpyo2apk-1.0.tar.gz` & `tmp/fpyo2apk-1.1.tar.gz`
...
+gzip compressed data, was "fpyo2apk-1.1.tar", last modified: Sun May  7 21:16:58 2023, max compression
```

## Comparing `fpyo2apk-1.0.tar` & `fpyo2apk-1.1.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.975265 fpyo2apk-1.1/
+-rw-r--r--   0 runner    (1001) docker     (123)     1071 2023-05-07 21:16:42.000000 fpyo2apk-1.1/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)       84 2023-05-07 21:16:42.000000 fpyo2apk-1.1/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (123)      366 2023-05-07 21:16:58.975265 fpyo2apk-1.1/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:42.000000 fpyo2apk-1.1/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.971265 fpyo2apk-1.1/fpyo2apk/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.971265 fpyo2apk-1.1/fpyo2apk/Tools/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/Tools/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      124 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/Tools/check_system.py
+-rw-r--r--   0 runner    (1001) docker     (123)      137 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/Tools/check_venv.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1285 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/Tools/unzip_assets.py
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.975265 fpyo2apk-1.1/fpyo2apk/assets/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/assets/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)   495603 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/assets/fpyo2apkdist.zip
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.975265 fpyo2apk-1.1/fpyo2apk/beeware_tools/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/beeware_tools/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2532 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/beeware_tools/edit_beeware_project.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1906 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/beeware_tools/the_app_py.py
+-rw-r--r--   0 runner    (1001) docker     (123)      977 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/beeware_tools/the_localhost_py.py
+-rw-r--r--   0 runner    (1001) docker     (123)      759 2023-05-07 21:16:42.000000 fpyo2apk-1.1/fpyo2apk/build.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-07 21:16:58.971265 fpyo2apk-1.1/fpyo2apk.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)      366 2023-05-07 21:16:58.000000 fpyo2apk-1.1/fpyo2apk.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      592 2023-05-07 21:16:58.000000 fpyo2apk-1.1/fpyo2apk.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-07 21:16:58.000000 fpyo2apk-1.1/fpyo2apk.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       18 2023-05-07 21:16:58.000000 fpyo2apk-1.1/fpyo2apk.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        9 2023-05-07 21:16:58.000000 fpyo2apk-1.1/fpyo2apk.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)      103 2023-05-07 21:16:42.000000 fpyo2apk-1.1/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-07 21:16:58.975265 fpyo2apk-1.1/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      633 2023-05-07 21:16:42.000000 fpyo2apk-1.1/setup.py
```

### Comparing `fpyo2apk-1.0/LICENSE` & `fpyo2apk-1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk/Tools/unzip_assets.py` & `fpyo2apk-1.1/fpyo2apk/Tools/unzip_assets.py`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk/assets/fpyo2apkdist.zip` & `fpyo2apk-1.1/fpyo2apk/assets/fpyo2apkdist.zip`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk/beeware_tools/edit_beeware_project.py` & `fpyo2apk-1.1/fpyo2apk/beeware_tools/edit_beeware_project.py`
...
### Comparing `fpyo2apk-1.0/fpyo2apk/beeware_tools/the_app_py.py` & `fpyo2apk-1.1/fpyo2apk/beeware_tools/the_app_py.py`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk/beeware_tools/the_localhost_py.py` & `fpyo2apk-1.1/fpyo2apk/beeware_tools/the_localhost_py.py`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk/build.py` & `fpyo2apk-1.1/fpyo2apk/build.py`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/fpyo2apk.egg-info/SOURCES.txt` & `fpyo2apk-1.1/fpyo2apk.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `fpyo2apk-1.0/setup.py` & `fpyo2apk-1.1/setup.py`
