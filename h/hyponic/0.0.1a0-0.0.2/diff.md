# Comparing `tmp/hyponic-0.0.1a0.tar.gz` & `tmp/hyponic-0.0.2.tar.gz`
...
## Comparing `hyponic-0.0.1a0.tar` & `hyponic-0.0.2.tar`
...
### Comparing `hyponic-0.0.1a0/README.md` & `hyponic-0.0.2/README.md`
...
### Comparing `hyponic-0.0.1a0/hyponic/metrics.py` & `hyponic-0.0.2/hyponic/metrics/classification.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/optimizer.py` & `hyponic-0.0.2/hyponic/hyponic.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/optimizers/ABC.py` & `hyponic-0.0.2/hyponic/optimizers/swarm_based/ABC.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/optimizers/ACO.py` & `hyponic-0.0.2/hyponic/optimizers/swarm_based/ACO.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/optimizers/SA.py` & `hyponic-0.0.2/hyponic/optimizers/physics_based/SA.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/optimizers/base_optimizer.py` & `hyponic-0.0.2/hyponic/optimizers/base_optimizer.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/space.py` & `hyponic-0.0.2/hyponic/space.py`
...
### Comparing `hyponic-0.0.1a0/hyponic/symtable.py` & `hyponic-0.0.2/hyponic/symtable.py`
