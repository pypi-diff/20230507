# Comparing `tmp/hikari_bot-0.3.9.tar.gz` & `tmp/hikari_bot-0.3.9.1.tar.gz`
...
### Comparing `hikari_bot-0.3.9/LICENSE` & `hikari_bot-0.3.9.1/LICENSE`
...
### Comparing `hikari_bot-0.3.9/PKG-INFO` & `hikari_bot-0.3.9.1/PKG-INFO`
...
+Metadata-Version: 2.1 Name: hikari-bot Version: 0.3.9.1 Summary: Nonebot2
...
+beautifulsoup4 (>=4.11.1,<5.0.0) Requires-Dist: httpx[http2] (>=0.22.0,<0.23.0)
